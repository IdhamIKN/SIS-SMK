...
@section('content')
    <div class="izin-wrap" style="padding-bottom: calc(var(--footer-h) + 88px);">
        ...
        <div class="page-strip page-strip-izin">
            ...
            <p>{{ $siswa->nama_lengkap }} <span class="text-muted">• {{ $siswa->nis ?? $siswa->nisn }}</span></p>
        </div>
        ...
        <form id="editSiswaForm" method="POST" action="{{ route('siswa.update', $siswa) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="c-body" style="padding:16px;">
                    ...
                    <div class="fgroup">
                        ...
                        <input type="text" id="nisn" name="nisn"
                            class="form-input @error('nisn') is-error @enderror" value="{{ old('nisn', $siswa->nisn) }}"
                    ...
                    <div class="grid-2">
                        <div class="fgroup">
                            ...
                            <input type="text" id="nis" name="nis"
                                class="form-input @error('nis') is-error @enderror" value="{{ old('nis', $siswa->nis) }}"
                        ...
                        <div class="toggle-wrap">
                            <label class="toggle-switch">
                                <input type="checkbox" name="status_aktif" value="1"
                                    {{ old('status_aktif', $siswa->status_aktif) ? 'checked' : '' }} id="statusAktif">
                ...
                <div class="c-body" style="padding:16px;">
                    <div class="fgroup">
                        ...
                        <textarea id="alamat" name="alamat" rows="3" class="form-input @error('alamat') is-error @enderror"
                            placeholder="Jalan, RT/RW..." maxlength="500">{{ old('alamat', $siswa->alamat) }}</textarea>
                        @error('alamat')
                            <div class="form-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="action-bar">
            <a href="{{ route('siswa.show', $siswa) }}" class="ab-btn ab-btn-back">
                <i class="fas fa-times"></i> Batal
            </a>
            <button type="submit" form="editSiswaForm" class="ab-btn ab-btn-primary">
