...
@section('content')
    <div class="izin-wrap" style="padding-bottom: calc(var(--footer-h) + 88px);">
        ...
        <div class="page-strip page-strip-izin">
            ...
            <h2><i class="fas fa-user-plus"></i> Tambah GTK Baru</h2>
        ...
        <form id="createGtkForm" method="POST" action="{{ route('gtk.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="c-body" style="padding:16px;">
                    ...
                    <div class="grid-2">
                        ...
                        <div class="fgroup">
                            ...
                            <input type="text" id="nik" name="nik"
                                class="form-input @error('nik') is-error @enderror" value="{{ old('nik') }}"
                        ...
                        <div class="fgroup">
                            ...
                            <input type="text" id="nuptk" name="nuptk"
                                class="form-input @error('nuptk') is-error @enderror" value="{{ old('nuptk') }}"
                    ...
                    <div class="fgroup">
                        ...
                        <div class="toggle-wrap">
                            ...
                            <span class="toggle-label" id="statusLabel">GTK Aktif</span>
                        </div>
                    </div>
                ...
                <div class="c-body" style="padding:16px;">
                    <div class="fgroup">
                        ...
                        <input type="tel" id="no_hp" name="no_hp"
                            class="form-input @error('no_hp') is-error @enderror" value="{{ old('no_hp') }}"
