<style>
    ...
    .page-strip p { font-size: .77rem; color: rgba(255,255,255,.8); margin-top: 3px; }
    ...
    .step.done::after { background: var(--event-primary); }
    .step-dot {
    ...
    .step.active .step-dot { background: var(--event-primary); color: #fff; }
    .step.done .step-dot { background: var(--event-primary); color: #fff; }
    ...
    .ci-e { background: var(--event-fade); }
    .ci-g { background: #dcfce7; }
    .ci-r { background: #fee2e2; }
    .ci-o { background: #fef3c7; }
    ...
    .c-head h3 {
        font-size: .87rem; font-weight: 600; color: var(--text-main); margin: 0;
    }
    .hbadge {
    ...
    .btn-sub {
        ...
        background: var(--event-primary); color: #fff;
        font-size: .95rem; font-weight: 700; border: none; cursor: pointer;
        box-shadow: 0 4px 14px rgba(14, 165, 233, .35);
        transition: all .2s;
        display: flex; align-items: center; justify-content: center; gap: 8px;
    }
    .btn-sub:hover:not(:disabled) { background: var(--event-dark); transform: translateY(-1px); }
    .btn-sub:disabled { background: #94a3b8; cursor: not-allowed; }
    ...
    .btn-event-primary { background: var(--event-primary); color: #fff; }
    .btn-event-primary:hover { background: var(--event-dark); }
    .btn-event-secondary {
        background: transparent; color: var(--text-muted);
        border: 1px solid var(--border);
    }
    .btn-event-secondary:hover { border-color: var(--event-primary); color: var(--event-primary); }
    .btn-event-danger { background: #ef4444; color: #fff; }
    .btn-event-danger:hover { background: #dc2626; }
    .btn-event-success { background: #16a34a; color: #fff; }
    .btn-event-success:hover { background: #15803d; }
    ...
    .form-input:focus { outline: none; border-color: var(--event-primary); }
    .form-label {
        font-weight: 600; color: var(--text-main);
        margin-bottom: 8px; display: block; font-size: .9rem;
    }
    ...
    .checkbox-item input[type="checkbox"] {
        width: 16px; height: 16px; accent-color: var(--event-primary);
    }

    /* Event list items */
    .event-item { transition: all .2s; }
    ...
    .btn-edit:hover { background: #fef3c7; border-color: #fcd34d; }
    .btn-delete { background: #fef2f2; color: #dc2626; border: 1px solid #fecaca; }
    .btn-delete:hover { background: #fee2e2; border-color: #fca5a5; }
    .btn-scan { background: #dcfce7; color: #15803d; border: 1px solid #86efac; }
    .btn-scan:hover { background: #bbf7d0; border-color: #4ade80; }

    /* Empty state */
    .empty-state { text-align: center; padding: 40px 20px; }
    .empty-icon { font-size: 4rem; color: var(--event-fade); margin-bottom: 16px; }
    ...
    .page-chip.active, .page-chip:hover {
        background: var(--event-primary); color: #fff;
    ...
    .scan-frame {
        width: 200px; height: 200px; border: 2px solid var(--event-primary);
        border-radius: 12px; position: relative;
        box-shadow: 0 0 0 9999px rgba(0,0,0,.5);
    }
    .scan-frame::before, .scan-frame::after {
        content: ''; position: absolute; width: 20px; height: 20px;
        border-color: var(--event-primary); border-style: solid;
    }
    ...
    .detail-row .dr-value { font-weight: 600; color: var(--text-main); text-align: right; }
    ...
    .event-table td { padding: 10px 8px; border-bottom: 1px solid #f1f5f9; }
    .event-table tr:last-child td { border-bottom: none; }
    .event-table tr:hover td { background: #f8fafc; }
    ...
    /* FAB */
    .fab-add {
        position: fixed; bottom: calc(var(--footer-h) + 16px); right: 20px;
        height: 50px; padding: 0 20px; border-radius: 25px;
        background: var(--event-primary); color: #fff;
        font-size: .9rem; font-weight: 700; font-family: inherit;
        display: inline-flex; align-items: center; gap: 8px;
        text-decoration: none; box-shadow: 0 6px 20px rgba(14, 165, 233, .4);
        z-index: 1000; transition: all .2s; border: none; cursor: pointer;
    }
    .fab-add:hover { background: var(--event-dark); box-shadow: 0 8px 24px rgba(14, 165, 233, .5); transform: translateY(-1px); }
    ...
    .ab-btn {
        ...
        gap: 7px; padding: 12px 16px; border-radius: 12px;
    ...
    .ab-btn-back { background: #f1f5f9; color: #475569; border: 1px solid var(--border); }
    .ab-btn-back:hover { background: #e2e8f0; color: #334155; }
    .ab-btn-primary { background: var(--event-primary); color: #fff !important; box-shadow: 0 3px 12px rgba(14,165,233,.3); }
    .ab-btn-primary:hover { filter: brightness(1.08); }
    .ab-btn-danger { background: #ef4444; color: #fff !important; box-shadow: 0 3px 12px rgba(239,68,68,.25); }
    ...
    .barcode-box {
        ...
        word-break: break-all; text-align: center; color: var(--text-muted);
    }

    /* Swal override */
    .swal2-popup {
        font-family: 'Plus Jakarta Sans', sans-serif !important;
        border-radius: 18px !important; padding: 28px 24px 24px !important;
    }
    .swal2-title { font-size: 1.1rem !important; font-weight: 700 !important; }
    .swal2-html-container { font-size: .875rem !important; }
    .swal2-actions { gap: 10px !important; margin-top: 20px !important; width: 100% !important; padding: 0 !important; }
    .swal2-actions .ab-btn { flex: 1; margin: 0 !important; }
</style>
